...
\begin{prop}[{\cite[Thm.\ 3.2.5]{AKL15}}]
  ...
  $\Ones$-structures carries the structure of a fibration category,
...
\begin{intlang}\label{intlang}
  ...
  \[\begin{tikzcd}
    {\Cxl_{\Sigmas,\Ones,\Ids,\Piext}} & \LCCCi \\
    {\Cxl_{\Sigmas,\Ones,\Ids}} & \Lexi
...
functor $\Cxl_{\HoTT}\rightarrow\ElToposi$ which should itself be a
