...
For example, the Blakers-Massey Theorem \cite{HFLL16} has been elegantly presented in the language of Homotopy Type
Theory \cite{Uni13}.
...
categories was developed by Voevodsky in \cite{Voe14a,Voe14b,Voe15a,Voe15b},
...
with them. We will introduce such structures in the next section.
\end{rmk}
...
which has been worked on in \cite{Isa16, Uem19, Bru20, BHL20, NU22}.
\end{rmk}
...
\begin{rmk}
  ...
  the property means that we have a judgment
